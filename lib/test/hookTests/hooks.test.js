...
describe('Typegoose', () => {
    describe('Hooks', () => {
        ...
        it('should test the updateMany hook', () => __awaiter(this, void 0, void 0, function* () {
            const dummy = yield dummy_1.model.insertMany([{ text: 'foobar42' }, { text: 'foobar42' }]);
            yield dummy_1.model.updateMany({
                text: 'foobar42',
            }, {
                text: 'lorem ipsum',
            });
            const foundUpdatedDummies = yield dummy_1.model.find({ text: 'updateManied' });
